...
{
    var $cols = array(
                        1 => array('Name'=>'Codigo','NameDB'=>'idcategoria','align'=>'center','width'=>'20'),
                        2 => array('Name'=>'Descripcion','NameDB'=>'descripcion','search'=>true),
                        3 => array('Name'=>'Orden','NameDB'=>'orden','search'=>true,'width'=>'50','align'=>'center'),
    ...
    public function create()
    {
        $data = array();
        $view = new View();        
        //$data['more_options'] = $this->more_options('categoria');        
        $view->setData($data);
